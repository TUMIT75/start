    ...
    <>
          ...
          <section className="py-14 sm:py-20 lg:py-28 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-3xl">
              ...
              <h1 className="text-3xl sm:text-5xl font-semibold text-gray-900 mt-3 tracking-tight">
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="bg-white rounded-2xl p-6 sm:p-10 border border-gray-200/80 shadow-xs">
                ...
                <div id="quizResultBox" className="hidden text-center py-6">
                  <div className="w-16 h-16 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center mx-auto text-2xl font-semibold mb-4 border border-emerald-200/60">
                    <Icon name="award" className="inline-block h-[1em] w-[1em] align-[-0.125em] shrink-0" />
                  </div>
                  <h3 className="text-2xl font-semibold text-gray-900">Your Communication Profile</h3>
                  ...
                  <div className="mt-6 p-4 rounded-xl bg-emerald-50/50 border border-emerald-200/80 max-w-md mx-auto text-left">
                    <span className="text-[10px] font-semibold uppercase tracking-wider text-gray-500 block">Recommended Pathway:</span>
                    <h4 className="text-base font-semibold text-gray-900 mt-1" id="quizRecommendedCourse">English for Professional Success & Vocal Gravitas</h4>
          ...
          <section className="py-16 sm:py-20 lg:py-28 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <h3 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-8 text-center tracking-tight">Complimentary Executive Playbooks</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-6 rounded-2xl border border-gray-200/80 bg-slate-50/50 hover:bg-white hover:border-gray-300 transition duration-200">
                  ...
                  <h4 className="font-semibold text-gray-900 text-base mb-2">The Boardroom Articulation Guide</h4>
                ...
                <div className="p-6 rounded-2xl border border-gray-200/80 bg-slate-50/50 hover:bg-white hover:border-gray-300 transition duration-200">
                  <Icon name="file-pdf" className="text-emerald-600 text-3xl mb-4 inline-block h-[1em] w-[1em] align-[-0.125em] shrink-0" />
                  <h4 className="font-semibold text-gray-900 text-base mb-2">The 2025 Executive Interview Blueprint</h4>
                ...
                <div className="p-6 rounded-2xl border border-gray-200/80 bg-slate-50/50 hover:bg-white hover:border-gray-300 transition duration-200">
                  ...
                  <h4 className="font-semibold text-gray-900 text-base mb-2">Vocal Resonance Warm-Up Drills</h4>
