          ...
          <div className="bg-white border-b border-gray-100 py-3.5">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <nav className="flex text-xs font-medium text-gray-500 items-center space-x-2">
                ...
                <span className="text-gray-900 font-semibold">Programmes & Masterclasses</span>
              </nav>
            </div>
          </div>
          ...
          <section className="py-12 sm:py-16 bg-white border-b border-gray-100">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="mt-8 p-4 bg-[#FAFAFA] rounded-2xl border border-emerald-100 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <span className="text-xs font-bold text-gray-900 block">Small Cohorts & Safe Learning Environments</span>
                ...
                <div className="shrink-0">
                  <span className="text-xs font-semibold text-emerald-700 bg-white px-3 py-1.5 rounded-full border border-emerald-200">
              ...
              <div className="flex flex-wrap gap-2 mt-6 pt-6 border-t border-gray-100" id="progFilterTabs">
                <button onClick={() => { filterProgrammes('all') }} className="prog-filter-btn px-4 py-2 rounded-full text-xs font-bold transition bg-emerald-600 text-white cursor-pointer shadow-xs whitespace-nowrap" data-cat="all">All Programmes (6)</button>
                <button onClick={() => { filterProgrammes('Communication') }} className="prog-filter-btn px-4 py-2 rounded-full text-xs font-bold transition bg-gray-100 hover:bg-gray-200 text-gray-700 cursor-pointer whitespace-nowrap" data-cat="Communication">Communication & English</button>
                <button onClick={() => { filterProgrammes('Career & Employability') }} className="prog-filter-btn px-4 py-2 rounded-full text-xs font-bold transition bg-gray-100 hover:bg-gray-200 text-gray-700 cursor-pointer whitespace-nowrap" data-cat="Career & Employability">Career & Employability</button>
                <button onClick={() => { filterProgrammes('Leadership') }} className="prog-filter-btn px-4 py-2 rounded-full text-xs font-bold transition bg-gray-100 hover:bg-gray-200 text-gray-700 cursor-pointer whitespace-nowrap" data-cat="Leadership">Leadership & Presence</button>
                <button onClick={() => { filterProgrammes('B2B Organisational') }} className="prog-filter-btn px-4 py-2 rounded-full text-xs font-bold transition bg-gray-100 hover:bg-gray-200 text-gray-700 cursor-pointer whitespace-nowrap" data-cat="B2B Organisational">Workforce & Teams</button>
              </div>
            </div>
          </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="catalogGrid">
                ...
                <div className="programme-card bg-white rounded-2xl overflow-hidden border border-gray-200/80 hover:border-emerald-400 hover:shadow-md transition duration-200 flex flex-col justify-between group" data-category="Communication">
                  ...
                  <div className="p-6 pt-0 flex items-center justify-between border-t border-gray-50 mt-auto">
                    <div className="text-sm font-extrabold text-gray-900">£1,450 <span className="text-xs font-normal text-gray-400">/ cohort</span></div>
                    <div className="flex space-x-2">
                      <Link href="/programmes/english-for-professional-success" className="px-3.5 py-2 border border-gray-200 text-xs font-bold text-gray-700 rounded-full hover:border-gray-900 cursor-pointer">Details</Link>
                      <Link href="/start-your-development?focus=English%20for%20Professional%20Success" className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-full shadow-xs cursor-pointer">Enrol</Link>
                    </div>
                  </div>
                </div>
                ...
                <div className="programme-card bg-white rounded-2xl overflow-hidden border border-gray-200/80 hover:border-emerald-400 hover:shadow-md transition duration-200 flex flex-col justify-between group" data-category="Leadership">
                  ...
                  <div className="p-6 pt-0 flex items-center justify-between border-t border-gray-50 mt-auto">
                    <div className="text-sm font-extrabold text-gray-900">£1,250 <span className="text-xs font-normal text-gray-400">/ cohort</span></div>
                    <div className="flex space-x-2">
                      <Link href="/start-your-development?focus=Executive%20Presence%20%26%20Vocal%20Resonance" className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-full shadow-xs cursor-pointer">Enrol</Link>
                    </div>
                  </div>
                </div>
                ...
                <div className="programme-card bg-white rounded-2xl overflow-hidden border border-gray-200/80 hover:border-emerald-400 hover:shadow-md transition duration-200 flex flex-col justify-between group" data-category="Career & Employability">
                  ...
                  <div className="p-6 pt-0 flex items-center justify-between border-t border-gray-50 mt-auto">
                    <div className="text-sm font-extrabold text-gray-900">£950 <span className="text-xs font-normal text-gray-400">/ learner</span></div>
                    <div className="flex space-x-2">
                      <Link href="/start-your-development?focus=Executive%20Career%20%26%20Headhunter%20Mastery" className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-full shadow-xs cursor-pointer">Enrol</Link>
                    </div>
                  </div>
                </div>
                ...
                <div className="programme-card bg-white rounded-2xl overflow-hidden border border-gray-200/80 hover:border-emerald-400 hover:shadow-md transition duration-200 flex flex-col justify-between group" data-category="Communication">
                  ...
                  <div className="p-6 pt-0 flex items-center justify-between border-t border-gray-50 mt-auto">
                    <div className="text-sm font-extrabold text-gray-900">£1,150 <span className="text-xs font-normal text-gray-400">/ cohort</span></div>
                    <div className="flex space-x-2">
                      <Link href="/start-your-development?focus=High-Stakes%20Negotiation" className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-full shadow-xs cursor-pointer">Enrol</Link>
                    </div>
                  </div>
                </div>
                ...
                <div className="programme-card bg-white rounded-2xl overflow-hidden border border-gray-200/80 hover:border-emerald-400 hover:shadow-md transition duration-200 flex flex-col justify-between group" data-category="Leadership">
                  ...
                  <div className="p-6 pt-0 flex items-center justify-between border-t border-gray-50 mt-auto">
                    <div className="text-sm font-extrabold text-gray-900">£1,100 <span className="text-xs font-normal text-gray-400">/ cohort</span></div>
                    <div className="flex space-x-2">
                      <Link href="/start-your-development?focus=Workplace%20Emotional%20Intelligence" className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-full shadow-xs cursor-pointer">Enrol</Link>
                    </div>
                  </div>
                </div>
                ...
                <div className="programme-card bg-white rounded-2xl overflow-hidden border border-gray-200/80 hover:border-emerald-400 hover:shadow-md transition duration-200 flex flex-col justify-between group" data-category="B2B Organisational">
                  ...
                  <div className="p-6 pt-0 flex items-center justify-between border-t border-gray-50 mt-auto">
                    <div className="text-sm font-extrabold text-gray-900">Custom <span className="text-xs font-normal text-gray-400">/ Proposal</span></div>
                    <div className="flex space-x-2">
                      <Link href="/organisational-development" className="px-3.5 py-2 border border-gray-200 text-xs font-bold text-gray-700 rounded-full hover:border-gray-900 cursor-pointer">B2B Page</Link>
                      <Link href="/start-your-development?focus=Corporate%20Organisational%20Academy" className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-full shadow-xs cursor-pointer">Inquire</Link>
                    </div>
                  </div>
                </div>
